...
- Uses lame-mail, a self-hosted transactional email service
...
- `LAME_MAIL_URL` - Base URL of the lame-mail API (self-hosted email service)
- `LAME_MAIL_API_KEY` - lame-mail API key (scoped to the `timesync` project)
